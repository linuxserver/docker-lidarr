...
<!-- Please read https://github.com/linuxserver/docker-lidarr/blob/nightly/.github/CONTRIBUTING.md -->
...
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Flidarr%2Fnightly%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/lidarr/nightly/index.html)
...
Simply pulling `lscr.io/linuxserver/lidarr:nightly` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/lidarr:nightly
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/lidarr:nightly
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/lidarr:nightly .
```
