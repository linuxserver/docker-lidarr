...
<!-- Please read the https://github.com/linuxserver/docker-lidarr/blob/nightly/.github/CONTRIBUTING.md -->
...
* Update the image: `docker pull lscr.io/linuxserver/lidarr:nightly`
...
* **27.10.22:** - Rebase nightly Alpine 3.16, migrate to s6v3.
